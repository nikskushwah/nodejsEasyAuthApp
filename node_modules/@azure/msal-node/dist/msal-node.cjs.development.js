...
var ClientApplication = /*#__PURE__*/function () {
  ...
  function ClientApplication(configuration) {
    ...
    msalCommon.TrustedAuthority.setTrustedAuthoritiesFromConfig(this.config.auth.knownAuthorities, this.config.auth.cloudDiscoveryMetadata);
  }
  /**
          ...
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              if (authorityString) {
                ...
                authority = msalCommon.AuthorityFactory.createInstance(authorityString, this.config.system.networkClient, this.config.auth.protocolMode);
              } else {
            ...
            case 10:
              ...
              throw msalCommon.ClientAuthError.createEndpointDiscoveryIncompleteError(_context6.t0);
  ...
  _createClass(ClientApplication, [{
    ...
    get: function get() {
      ...
      this._authority = msalCommon.AuthorityFactory.createInstance(this.config.auth.authority || msalCommon.Constants.DEFAULT_AUTHORITY, this.config.system.networkClient, this.config.auth.protocolMode);
      return this._authority;
    }
  }]);
