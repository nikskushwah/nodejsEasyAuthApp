import { ProtocolMode, LogLevel, StringUtils, AccountEntity, CacheManager, IdTokenEntity, AccessTokenEntity, RefreshTokenEntity, AppMetadataEntity, ServerTelemetryEntity, ThrottlingEntity, TokenCacheContext, Constants as Constants$1, ServerTelemetryManager, Logger, TrustedAuthority, AuthorityFactory, AuthorizationCodeClient, RefreshTokenClient, SilentFlowClient, ClientAuthError, DeviceCodeClient, UsernamePasswordClient, TimeUtils, ClientCredentialClient, OnBehalfOfClient } from '@azure/msal-common';
...
var ClientApplication = /*#__PURE__*/function () {
  ...
  function () {
    var _getAuthCodeUrl = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(request) {
      var authClientConfig, authorizationCodeClient;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.buildOauthClientConfiguration(request.authority);

            case 3:
              authClientConfig = _context.sent;
              this.logger.verbose("Auth client config generated");
              authorizationCodeClient = new AuthorizationCodeClient(authClientConfig);
              return _context.abrupt("return", authorizationCodeClient.getAuthCodeUrl(this.initializeRequest(request)));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              validRequest = this.initializeRequest(request);
              serverTelemetryManager = this.initializeServerTelemetryManager(ApiId.acquireTokenByCode, validRequest.correlationId);
              _context2.prev = 3;
              _context2.next = 6;
              return this.buildOauthClientConfiguration(request.authority, serverTelemetryManager);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.t0 = this.config.auth.clientId;
              _context5.next = 4;
              return this.createAuthority(authority);

            case 4:
              _context5.t1 = _context5.sent;
              _context5.t2 = this.config.auth.knownAuthorities;
              _context5.t3 = this.config.auth.cloudDiscoveryMetadata;
              _context5.t4 = this.config.auth.clientCapabilities;
              _context5.t5 = this.config.auth.protocolMode;
              _context5.t6 = {
                clientId: _context5.t0,
                authority: _context5.t1,
                knownAuthorities: _context5.t2,
                cloudDiscoveryMetadata: _context5.t3,
                clientCapabilities: _context5.t4,
                protocolMode: _context5.t5
              };
              _context5.t7 = {
                loggerCallback: this.config.system.loggerOptions.loggerCallback,
                piiLoggingEnabled: this.config.system.loggerOptions.piiLoggingEnabled
              };
              _context5.t8 = this.cryptoProvider;
              _context5.t9 = this.config.system.networkClient;
              _context5.t10 = this.storage;
              _context5.t11 = serverTelemetryManager;
              _context5.t12 = {
              ...
              _context5.t14 = this.config.cache.cachePlugin;
              _context5.t15 = this.tokenCache;
              return _context5.abrupt("return", {
                authOptions: _context5.t6,
                loggerOptions: _context5.t7,
                cryptoInterface: _context5.t8,
                networkInterface: _context5.t9,
                storageInterface: _context5.t10,
                serverTelemetryManager: _context5.t11,
                clientCredentials: _context5.t12,
                libraryInfo: _context5.t13,
                persistencePlugin: _context5.t14,
                serializableCache: _context5.t15
              });
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return _context6.abrupt("return", authority);

            case 4:
              _context6.prev = 4;
              _context6.next = 7;
              return authority.resolveEndpointsAsync();
            ...
            case 10:
              ...
              throw ClientAuthError.createEndpointDiscoveryIncompleteError(_context6.t0);
  ...
  _createClass(ClientApplication, [{
    ...
    get: function get() {
      ...
      this._authority = AuthorityFactory.createInstance(this.config.auth.authority || Constants$1.DEFAULT_AUTHORITY, this.config.system.networkClient, this.config.auth.protocolMode);
      return this._authority;
    }
  }]);
...
var ConfidentialClientApplication = /*#__PURE__*/function (_ClientApplication) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              this.logger.verbose("Auth client config generated");
              clientCredentialClient = new ClientCredentialClient(clientCredentialConfig);
              return _context.abrupt("return", clientCredentialClient.acquireToken(request));
  ...
  function () {
    var _acquireTokenOnBehalfOf = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(request) {
      var clientCredentialConfig, oboClient;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 3:
              ...
              this.logger.verbose("Auth client config generated");
              oboClient = new OnBehalfOfClient(clientCredentialConfig);
              return _context2.abrupt("return", oboClient.acquireToken(this.initializeRequest(request)));
...
export { ConfidentialClientApplication, CryptoProvider, Deserializer, PublicClientApplication, Serializer, Storage, TokenCache, buildAppConfiguration };
